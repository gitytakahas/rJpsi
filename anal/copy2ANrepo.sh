...
do
    ...
    do
	echo ${var}
	cp ${pnfs_prefix}/${year}_inclusive_None/plots/${var}.pdf ${prefix}/${year}_inclusive_None/plots
    done
done
...
do
    ...
    cp combine_sb3p5_sr4_inv/sb_sr_data_obs/tau_rhomass_unrolled_var_${year}.pdf ${prefix}/combine_sb3p5_sr4/inv_sb_sr_data_obs    
    cp combine_sb3p5_sr4/sb_sr_bg_ul/tau_rhomass_unrolled_var_${year}.pdf ${prefix}/combine_sb3p5_sr4/sb_sr_bg_ul/
    cp combine_sb3p5_sr4/lp_sb_data_obs/tau_rhomass_unrolled_var_${year}.pdf ${prefix}/combine_sb3p5_sr4/lp_sb_data_obs/
...
do
    ...
    do
	echo ${year}, ${var}
	cp ${pnfs_prefix}/${year}_sr_None/plots/${var}_coarse.pdf ${prefix}/${year}_sr_None/plots/
	cp ${pnfs_prefix}/${year}_sb_None/plots/${var}_coarse.pdf ${prefix}/${year}_sb_None/plots/
    done
done
...
cp -r combine_sb3p5_sr4_simultaneous/syscompare $prefix/
