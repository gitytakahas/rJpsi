...
vardir["tau_pt_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0, 'xmax':25, 'xtitle':'tau pT (GeV)', 'var':'tau_pt'}
vardir["tau_eta"] = {'tree':'tree',  'nbin':30, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'tau eta'}
vardir["tau_eta_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'tau eta', 'var':'tau_eta'}
vardir["tau_eta_fine"] = {'tree':'tree',  'nbin':50, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'tau eta', 'var':'tau_eta'}
...
vardir["tau_vprob_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':1, 'xtitle':'Tau vertex prob.', 'var':'tau_vprob'}
...
vardir["tau_fl3d_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':1., 'xtitle':'Tau flight length', 'var':'tau_fl3d'}
...
vardir["tau_sumofdnn_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':3., 'xtitle':'Sum of DNN', 'var':'tau_sumofdnn'}
vardir["tau_sumofdnn_1prong_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':3., 'xtitle':'Sum of DNN 1prong', 'var':'tau_sumofdnn_1prong'}
vardir["tau_sumofdnn_otherB_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':3., 'xtitle':'Sum of DNN otherB', 'var':'tau_sumofdnn_otherB'}
vardir["tau_sumofdnn_pu_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':3., 'xtitle':'Sum of DNN pu', 'var':'tau_sumofdnn_pu'}
...
vardir["tau_rhomass1_fine"] = {'tree':'tree',  'nbin':25, 'xmin':0.4, 'xmax':0.6, 'xtitle':'Tau rhomass1 (GeV)', 'var':'tau_rhomass1'}
vardir["tau_rhomass2_fine"] = {'tree':'tree',  'nbin':25, 'xmin':0.4, 'xmax':0.6, 'xtitle':'Tau rhomass2 (GeV)', 'var':'tau_rhomass2'}
vardir["tau_rhomass1_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0.2, 'xmax':1.4, 'xtitle':'Tau rhomass1 (GeV)', 'var':'tau_rhomass1'}
vardir["tau_rhomass2_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0.2, 'xmax':1.4, 'xtitle':'Tau rhomass2 (GeV)', 'var':'tau_rhomass2'}
...
vardir["b_mindoca_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':0.01, 'xtitle':'B mindoca', 'isLog':True, 'var':'b_mindoca'}
...
vardir["b_pt_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':10., 'xmax':50, 'xtitle':'B pT (GeV)', 'var':'b_pt'}
vardir["b_eta"] = {'tree':'tree',  'nbin':30, 'xmin':-3., 'xmax':3., 'xtitle':'B eta'}
vardir["b_eta_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':-3., 'xmax':3., 'xtitle':'B eta', 'var':'b_eta'}
vardir["b_eta_fine"] = {'tree':'tree',  'nbin':50, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'B eta', 'var':'b_eta'}
...
vardir["b_vprob_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0, 'xmax':1, 'xtitle':'B vertex prob.', 'isLog':True, 'var':'b_vprob'}
vardir["b_alpha"] = {'tree':'tree',  'nbin':30, 'xmin':0.95, 'xmax':1, 'xtitle':'B cos(alpha)'}
vardir["b_alpha_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0.95, 'xmax':1, 'xtitle':'B cos(alpha)', 'var':'b_alpha'}
...
vardir["b_pvips_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':20., 'xtitle':'B pvips', 'var':'b_pvips'}
vardir["b_fls3d_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':30., 'xtitle':'B flight length sig.', 'var':'b_fls3d'}
vardir["b_fl3d_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':1., 'xtitle':'B flight length', 'var':'b_fl3d'}
vardir["b_lips_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':-10., 'xmax':10., 'xtitle':'B lips', 'var':'b_lips'}
...
vardir["dr_b_pv_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':0.6, 'xtitle':'#Deltar (B, bbPV) (cm)', 'var':'dr_b_pv'}
...
vardir["dr_jpsi_tau_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0., 'xmax':0.4, 'xtitle':'#Deltar (J/psi, tau) (cm)', 'var':'dr_jpsi_tau'}
vardir["dr_jpsi_tau_fine"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':0.1, 'xtitle':'#Deltar (J/psi, tau) (cm)', 'var':'dr_jpsi_tau'}
...
vardir["jpsi_pt_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0, 'xmax':40, 'xtitle':'jpsi pT (GeV)', 'var':'jpsi_pt'}
vardir["jpsi_eta_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'jpsi eta', 'var':'jpsi_eta'}
vardir["jpsi_eta_fine"] = {'tree':'tree',  'nbin':50, 'xmin':-2.5, 'xmax':2.5, 'xtitle':'jpsi eta', 'var':'jpsi_eta'}
...
vardir["jpsi_mass_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':2.9, 'xmax':3.3, 'xtitle':'jpsi mass', 'var':'jpsi_mass'}
vardir["jpsi_fls3d_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0, 'xmax':30, 'xtitle':'jpsi flight sig.', 'var':'jpsi_fls3d'}
vardir["jpsi_fl3d_coarse"] = {'tree':'tree',  'nbin':10, 'xmin':0, 'xmax':1., 'xtitle':'jpsi flight length', 'var':'jpsi_fl3d'}
vardir["jpsi_vprob"] = {'tree':'tree',  'nbin':30, 'xmin':0, 'xmax':1., 'xtitle':'jpsi vprob', 'var':'jpsi_vprob'}
vardir["jpsi_alpha2d"] = {'tree':'tree',  'nbin':30, 'xmin':0.97, 'xmax':1., 'xtitle':'jpsi alpha (2D)', 'var':'jpsi_alpha2d'}
vardir["jpsi_fls2d"] = {'tree':'tree',  'nbin':30, 'xmin':0, 'xmax':30, 'xtitle':'jpsi fls (2D)', 'var':'jpsi_fls2d'}
vardir["jpsi_dr"] = {'tree':'tree',  'nbin':30, 'xmin':0, 'xmax':1, 'xtitle':'jpsi dR'}
vardir["jpsi_maxdoca"] = {'tree':'tree',  'nbin':30, 'xmin':0, 'xmax':0.01, 'xtitle':'jpsi maxdoca'}
...
vardir["pi1_d0sig"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':20., 'xtitle':'pi1 d0sig'}
vardir["pi1_mumuTrk_vprob"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':1., 'xtitle':'pi1 mumuTrk vprob'}
vardir["pi1_mumuTrk_red_chi2"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':15., 'xtitle':'pi1 mumuTrk red. chi2', 'var':'pi1_mumuTrk_chi2/pi1_mumuTrk_ndof'}
...
vardir["pi2_d0sig"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':20., 'xtitle':'pi2 d0sig'}
vardir["pi2_mumuTrk_vprob"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':1., 'xtitle':'pi2 mumuTrk vprob'}
vardir["pi2_mumuTrk_red_chi2"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':15., 'xtitle':'pi2 mumuTrk red. chi2', 'var':'pi2_mumuTrk_chi2/pi2_mumuTrk_ndof'}
...
vardir["pi3_d0sig"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':20., 'xtitle':'pi3 d0sig'}
vardir["pi3_mumuTrk_vprob"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':1., 'xtitle':'pi3 mumuTrk vprob'}
vardir["pi3_mumuTrk_red_chi2"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':15., 'xtitle':'pi3 mumuTrk red. chi2', 'var':'pi3_mumuTrk_chi2/pi3_mumuTrk_ndof'}
...
#vardir["Dxgbs"] = {'tree':'tree',  'nbin':100, 'xmin':0, 'xmax':9, 'xtitle':'DXGB output score', 'var':'Dxgbs', 'isRight':True}
