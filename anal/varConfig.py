...
vardir["tau_mass_zoom"] = {'tree':'tree',  'nbin':40, 'xmin':0.3, 'xmax':1.9, 'xtitle':'Tau mass wide (GeV)', 'var':'tau_mass'}
...
vardir["b_mcorr"] = {'tree':'tree',  'nbin':30, 'xmin':3, 'xmax':15, 'xtitle':'B corrected mass (GeV)'}
#vardir["m_corr_bd"] = {'tree':'tree',  'nbin':30, 'xmin':3, 'xmax':15, 'xtitle':'B corrected mass bd (GeV)'}
vardir["b_mass"] = {'tree':'tree',  'nbin':50, 'xmin':3.5, 'xmax':7, 'xtitle':'B mass (GeV)'}
vardir["b_mass_simple"] = {'tree':'tree',  'nbin':50, 'xmin':3.5, 'xmax':7, 'xtitle':'B mass simple (GeV)'}
...
vardir["q2"] = {'tree':'tree',  'nbin':30, 'xmin':2., 'xmax':11., 'xtitle':'q2'}
vardir["mm2"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':8., 'xtitle':'missing mass squared'}
vardir["ptmiss"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':30., 'xtitle':'ptmiss'}
vardir["estar"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':3.5, 'xtitle':'E*'}
vardir["B_ptback"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':70., 'xtitle':'B pT back (GeV)'}

vardir["q2_simple"] = {'tree':'tree',  'nbin':30, 'xmin':2., 'xmax':11., 'xtitle':'q2'}
vardir["mm2_simple"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':8., 'xtitle':'missing mass squared'}
vardir["ptmiss_simple"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':30., 'xtitle':'ptmiss'}
vardir["estar_simple"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':3.5, 'xtitle':'E*'}
vardir["B_ptback_simple"] = {'tree':'tree',  'nbin':30, 'xmin':0., 'xmax':70., 'xtitle':'B pT back (GeV)'}
...
vardir["xgbs"] = {'tree':'tree',  'nbin':30, 'xmin':-15, 'xmax':15, 'xtitle':'zoom XGB output score', 'var':'xgbs', 'isRight':True}
vardir["xgbs_log"] = {'tree':'tree',  'nbin':30, 'xmin':-15, 'xmax':15, 'xtitle':'zoom XGB output score', 'var':'xgbs', 'isLog':True}
...
vardir["perEVT_sig"] = {'tree':'tree',  'nbin':20, 'xmin':0., 'xmax':1, 'xtitle':'perEVT DNN sig'}
