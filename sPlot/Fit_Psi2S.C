...
void fit_Psi2S() {
  ...
  //  TFile *ntuple_mc = new TFile("/pnfs/psi.ch/cms/trivcat/store/user/ytakahas/RJpsi_Validation/job_pt_BcJpsiTauNu//BcJpsiX_ul_2018/Myroot.root");
  //  TFile *ntuple_mc = new TFile("/pnfs/psi.ch/cms/trivcat/store/user/ytakahas/RJpsi_Validation/job_pt_BcJpsiTauNu//BcJpsiX_ul_2018/Myroot.root");
  TFile *ntuple_mc = new TFile("/pnfs/psi.ch/cms/trivcat/store/user/ytakahas/RJpsi_Validation/job_pt_BcJpsiTauNu/Data_2018/data_training_v2.root");
...
//#endif
  ...
  //  RooAbsReal* fracIn3 = e_mSig.createIntegral(jpsi_kpipi, Range("signal3")) ; cout << "frac" << fracIn3->getVal() << ",  cut_mc" << cut_mc->sumEntries() <<  " => first integral: " << fracIn3->getVal()*cut_mc->sumEntries() << endl;
