...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   dataloader->AddVariable( "b_eta",                "b_eta", "", 'F');
   dataloader->AddVariable( "b_alpha",                "b_alpha", "", 'F');
   dataloader->AddVariable( "b_vprob",                "b_vprob", "", 'F');
   dataloader->AddVariable( "b_lips",                "b_lips", "", 'F');
   dataloader->AddVariable( "b_pvips",                "b_pvips", "", 'F');
   dataloader->AddVariable( "b_mindoca",                "b_mindoca", "", 'F');
   dataloader->AddVariable( "dr_b_pv",                "dr_b_pv", "", 'F');
   //   dataloader->AddVariable( "dr_jpsi_tau",                "dr_jpsi_tau", "", 'F');
   dataloader->AddVariable( "tau_fls3d",                "tau_fls3d", "", 'D');
