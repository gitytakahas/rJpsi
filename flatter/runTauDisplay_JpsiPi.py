...
from TreeProducerJpsiPi import *
...
parser.add_option("-f", "--file", default="root://storage01.lcg.cscs.ch/pnfs/lcg.cscs.ch/cms/trivcat/store/user/ytakahas/BcToJPsiMuMu_JpsiPi_2018_20221212/BcToJPsiMuMu_inclusive_TuneCP5_13TeV-bcvegpy2-pythia8-evtgen/RunIISummer20UL18MiniAODv2-106X_upgrade2018_realistic_v16_L1v1_ext2-v1/221212_142217/0000/flatTuple_99.root", type="string", help="file", dest="file") 
...
out = TreeProducerJpsiPi(options.out, options.type)
...
#            print final_daus
            if final_daus==[211, 443]:
                out.gen_sig_decay[0] = 0 ##Bc -> Jpsi pi 
            elif final_daus==[321, 443]:
                out.gen_sig_decay[0] = 1 ##Bc -> Jpsi K
            else:
                out.gen_sig_decay[0] = -1 #others
